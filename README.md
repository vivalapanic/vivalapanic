...
Опыт тестирования Backend'a (API, БД, Swagger, интеграции + автотесты JS), Frontend'a (web+mobile), LLM-ботов с RAG-архитектурой, документацию (дизайн, ТИ, ПИ и т.д.). Все виды тестирования от тестирования новых функциональностей до пост-релизного, анализ логов. Разработка тестовой документации (тест-кейсы, методологии, планов и т.д.). Обучение, контроль и ревью результатов работы коллег.
...
*2023-*
- Тестирование Back-End'a, API, баз данных, swagger'a.
- Разработка api-автотестов в Postman.
- Тестирование мобильных приложений (IOS, Android, Flutter): функциональное и нефункциональное тестирование, тестирование событий и push-уведомлений.
- Тестирование Web приложений (в том числе WebSocket): кроссбраузерное, локальное с помощью Visual Studio Code (Git), тестирование GUI.
- Тестирование AI-ботов с RAG: разработка методологии, анализ промпта, результатов работы LLM, БД и интерфейса приложения-бота.
- Проведение функционального, регрессионного, приемочного, интеграционного, пред и пост релизного тестирования.
- Написание и поддержка тестовой документации: методология тестирования, тест-кейсы, чек-листы, отчеты о тестировании, сбор метрик по релизам.
- Самостоятельная приоритезация и оценка задач, ведение эпиков, ревью и контроль работы коллег на проекте, распределение задач в команде (JIRA). 
